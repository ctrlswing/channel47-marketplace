...
describe('Error Handling', () => {
  test('handles query validation errors', async () => {
    const { blockMutations } = await import('../utils/validation.js');
  ...
  test('handles missing required params', async () => {
    const { validateRequired } = await import('../utils/validation.js');
  ...
  test('handles invalid enum values', async () => {
    const { validateEnum } = await import('../utils/validation.js');
  ...
  test('handles missing customer ID', async () => {
    const { getCustomerId } = await import('../utils/validation.js');
