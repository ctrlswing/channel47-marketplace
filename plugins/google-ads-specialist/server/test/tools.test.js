...
describe('GAQL Templates', () => {
  test('buildQuery substitutes date parameters', async () => {
    const { buildQuery, TEMPLATES } = await import('../utils/gaql-templates.js');
  ...
  test('TEMPLATES contains required templates', async () => {
    const { TEMPLATES } = await import('../utils/gaql-templates.js');
...
describe('Query Validator', () => {
  test('validateQuery returns valid for correct query', async () => {
    const { validateQuery } = await import('../utils/query-validator.js');
...
describe('Prompts', () => {
  test('getPromptsList returns all prompts', async () => {
    const { getPromptsList } = await import('../prompts/templates.js');
  ...
  test('renderPrompt substitutes variables', async () => {
    const { renderPrompt } = await import('../prompts/templates.js');
...
describe('Resources', () => {
  test('getResourcesList returns all resources', async () => {
    const { getResourcesList } = await import('../resources/index.js');
